...
import projectC0 from "../assets/img/pti.png";
import projectC1 from "../assets/img/solit.png";
import projectC2 from "../assets/img/cbp.png";
import projectC3 from "../assets/img/pippo.png";
import projectC4 from "../assets/img/KTB.png";
import projectC5 from "../assets/img/cimuning.png";
...
export const Project = () => {
   const projectsCompany = [
      {
         title: "Putra Teknologi Indonesia Website",
         description: "Company Profile",
         techStack: "Wordpress, Elementor, CSS, JS",
         imgUrl: projectC0,
         webUrl: "https://putrateknologiindonesia.com/",
      },
      {
         title: "SOLIT Website",
         description: "Company Profile",
         techStack: "Wordpress, Elementor, CSS, JS",
         imgUrl: projectC1,
         webUrl: "https://solit.putrateknologiindonesia.com/",
      },
      {
         title: "CBP Website",
         description: "Company Profile",
      ...
      {
         title: "PIPPO CHEMICALS Website",
         description: "Company Profile",
         techStack: "Wordpress, Elementor, CSS, JS",
         imgUrl: projectC3,
         webUrl: "https://pippochemicals.com/",
      },
      {
         title: "KTB Website",
         description: "Company Profile",
